...
def make_csv():
    ...
    photo_writer.writerow(['photo_title','date_taken', 'country', 'longitude', 'latitude', 'url'])
    for photo in make_photo_inst():
    	photo_writer.writerow([photo.title, photo.date_taken, photo.country, photo.longitude, photo.latitude, photo.url])
    photo_csv.close()
